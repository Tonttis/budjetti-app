...
Rakennettu **Next.js:llä (App Router)**, **Bunilla** ja **MongoDB:llä**. (Alunperin testattu Angular CLI:n avulla. En lisännyt ohjeita sille sillä minun palvelin ei lähtenyt Angular:in avulla toimimaan kun käytän Dockerfile.)
